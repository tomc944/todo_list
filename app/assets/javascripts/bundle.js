...
/***/ function(module, exports) {
	...
	var TodoStore = {
	  ...
	  destroy: function (id) {
	    var deleteItem = this.find(id);
	    var idx = _todos.indexOf(deleteItem);
	  ...
	  updateDone: function (id) {
	    var updateItem = this.find(id);
	    var idx = _todos.indexOf(updateItem);
	
	    if (updateItem) {
	      $.ajax({
	        url: "/api/todos/" + id,
	        data: { todos: updateItem },
	        type: "PATCH",
	        success: (function () {
	          this.toggleDone(updateItem);
	          TodoStore.changed();
	        }).bind(this)
	      });
	    }
	  ...
	  toggleDone: function (updateItem) {
